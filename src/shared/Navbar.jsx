...
const Navbar = () => {
  const navOptions = (
    <>
      ...
      <li>
        <Link to="/TeacherApply">Teach On SkillShare</Link>
      </li>
    </>
  );

  return (
    <div className="fixed z-10 w-full h-20 bg-white/30 backdrop-blur-xl border-b border-white/20 shadow-sm">
      <div className="navbar max-w-screen-xl mx-auto h-full px-4">
        {/* Navbar Start */}
        <div className="navbar-start">
          ...
          <Link to="/">
            <img
              src="https://i.ibb.co.com/q3zhWkty/EduNova.png"
              width={150}
              alt="EduNova Logo"
              className="mx-auto"
            />
        ...
        <div className="navbar-end gap-3 hidden md:flex">
          <Link to="/signIn">
            <button className="btn btn-sm md:btn-md md:text-lg">Sign In</button>
          </Link>
          <Link to="/signUp">
            <button className="btn btn-sm md:btn-md md:text-lg">Sign Up</button>
          </Link>
        </div>
      </div>
    </div>
